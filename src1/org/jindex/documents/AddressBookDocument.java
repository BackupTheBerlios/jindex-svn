                ...
                while (st1.hasMoreTokens()) {
                    ...
                    if (key != null && data != null) {
                        if ("EMAIL".equalsIgnoreCase(key)) {
                            doc.add(new Field("emailaddress", data.getBytes(), Field.Store.YES));
                        }
                        if ("FN".equalsIgnoreCase(key)) {
                            doc.add(new Field("fullname", data.getBytes(), Field.Store.YES));
                        }
                        if ("X-AIM".equalsIgnoreCase(key)) {
                            doc.add(new Field("instantmessageaddress", data.getBytes(), Field.Store.YES));
                        }
                        ...
                        if ("END".equalsIgnoreCase(key) && "VCARD".equalsIgnoreCase(data)) {
                            if (inphotomode) {
                                doc.add(new Field("photo", photo.getBytes(), Field.Store.NO));
                            }
                            doc.add(new Field("type", "EvolutionAddressBook".getBytes(), Field.Store.YES));
